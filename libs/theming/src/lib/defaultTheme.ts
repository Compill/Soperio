...
export const defaultTheme: Theme = {
  ...
  effects: {
    boxShadow: {
      xs: '0 0 0 1px var(--so-shadow-color, rgba(0, 0, 0, 0.05))',
      sm: '0 1px 2px 0 var(--so-shadow-color, rgba(0, 0, 0, 0.05))',
      md: '0 1px 3px 0 var(--so-shadow-color, rgba(0, 0, 0, 0.1)), 0 1px 2px 0 var(--so-shadow-color, rgba(0, 0, 0, 0.06))',
      default: '0 4px 6px -1px var(--so-shadow-color, rgba(0, 0, 0, 0.1)), 0 2px 4px -1px var(--so-shadow-color, rgba(0, 0, 0, 0.06))',
      lg: '0 10px 15px -3px var(--so-shadow-color, rgba(0, 0, 0, 0.1)), 0 4px 6px -2px var(--so-shadow-color, rgba(0, 0, 0, 0.05))',
      xl: '0 20px 25px -5px var(--so-shadow-color, rgba(0, 0, 0, 0.1)), 0 10px 10px -5px var(--so-shadow-color, rgba(0, 0, 0, 0.04))',
      x2: '0 25px 50px -12px var(--so-shadow-color, rgba(0, 0, 0, 0.25))',
      inner: 'inset 0 2px 4px 0 var(--so-shadow-color, rgba(0, 0, 0, 0.06))',
      outline: '0 0 0 3px var(--so-shadow-color, rgba(66, 153, 225, 0.5))',
      none: 'none',
    }
  },
  flexbox: {
