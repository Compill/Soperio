...
export type ThemeStyleFn = (value: StyleProp, theme: {}, direction: boolean, darkMode: boolean) => Style;
...
function mergeTraitPropIfExist<P extends {}>(props: P, theme: {})
{
...
export function parseProps<P extends {}>(props: P, theme: {}, direction: boolean, darkMode: boolean)
{
