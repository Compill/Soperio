...
export default function Test({ ...props })
{
  ...
  return (
    <Container dflex center flexCol size="x2" justifyContent="center" py="48" w="30%">
      <div mb="32" h="16" bgGradient bgGradientDir="to top right" bgGradientFrom="pink-500" bgGradientVia="yellow-500" bgGradientTo="sky-500"/>
      <div mb="32" h="16" bgGradient="radial" bgGradientFrom="pink-500" bgGradientVia="yellow-500" bgGradientTo="sky-500"/>
      <div mb="32" h="16" bgGradient="conic" bgGradientFrom="pink-500" bgGradientVia="yellow-500" bgGradientTo="sky-500"/>
      <div h="32" bgColor="sky-500" hover_bgColor="pink-500" transition="colors" duration="5000ms" />
      <div>
